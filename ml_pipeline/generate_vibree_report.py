...
# Paths
DATA_PATH = "data/raw/Vibree_synthetic_stress_dataset.csv"
RESULTS_DIR = "vibree_results"
...
"""
    ...
    with open("Vibree_Vibree_Validation_Report.md", "w") as f:
        f.write(md_content)
    
    print("Done! Report saved to Vibree_Vibree_Validation_Report.md")
